...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "controls.viewStudy": "Voir la page de l'étude",
    ...
    "ctx.allPhotos": "Toutes les photos ({count})",
    "ctx.terrainPhotos": "Vues du terrain ({count})",
    "ctx.gbifTitle": "Observations GBIF",
    "ctx.gbifHint": "Photos naturalistes réelles de l'espèce observée près du trajet (GBIF). Cliquez pour les afficher.",
    "ctx.tab.human": "Humain",
    "ctx.tab.wild": "Non humain",
    "ctx.terrainEmpty": "Aucune vue du terrain (Street View, Mapillary, Wikimedia) dans ce rayon.",
    "ctx.gbifEmpty": "Aucune observation GBIF de l'espèce dans ce rayon.",
    ...
    "story.docTitle": "AnimalView — Récit cartographique",
    "story.kicker": "Récit cartographique · données réelles",
    "story.setupTitle": "Racontez un trajet",
    "story.setupBody": "Choisissez une étude et un individu réels. Nous composons un récit défilant à partir de son trajet GPS et des meilleures photos de terrain rencontrées en chemin.",
    "story.build": "Composer le récit",
    "story.phaseMatching": "Recherche des images de terrain…",
    "story.phaseEnriching": "Lecture du terrain et de la météo…",
    "story.realDataOnly": "Données réelles uniquement",
    "story.openMap": "Carte interactive →",
    "story.reconfigure": "Reconfigurer",
    "story.error": "Impossible de composer le récit. Réessayez.",
    "story.noImagery": "Aucune image de terrain réelle n'a été trouvée le long de ce trajet. Le tracé reste affiché, sans chapitres photo.",
    "story.scrollHint": "Faites défiler · {count} chapitres",
    "story.chapter": "Chapitre",
    "story.statDistance": "Distance totale",
    "story.statDuration": "Durée",
    "story.statFixes": "Points GPS",
    "story.statPeriod": "Période",
    "story.daysValue": "{count} jours",
    "story.dayLabel": "Jour {count}",
    "story.legSummary": "{cumulative} km parcourus depuis le départ · +{leg} km depuis le chapitre précédent.",
    "story.terrainReading": "Lecture du terrain",
    "story.photoAlt": "Photo de terrain réelle près du trajet",
    "story.outroTitle": "Un récit fait de données réelles",
    "story.outroBody": "Chaque chapitre repose sur des positions GPS vérifiées, des photos géolocalisées réelles et la météo historique au moment du passage. Aucune émotion ni intention animale n'est inventée.",
    "story.restart": "Revenir au début",
  ...
  en: {
    ...
    "controls.viewStudy": "View study page",
    ...
    "ctx.allPhotos": "All photos ({count})",
    "ctx.terrainPhotos": "Terrain views ({count})",
    "ctx.gbifTitle": "GBIF sightings",
    "ctx.gbifHint": "Real naturalist photos of the species observed near the track (GBIF). Tap to view.",
    "ctx.tab.human": "Human",
    "ctx.tab.wild": "Non-human",
    "ctx.terrainEmpty": "No terrain views (Street View, Mapillary, Wikimedia) within this radius.",
    "ctx.gbifEmpty": "No GBIF observations of the species within this radius.",
    ...
    "story.docTitle": "AnimalView — Map story",
    "story.kicker": "Map story · real data",
    "story.setupTitle": "Tell a journey",
    "story.setupBody": "Pick a real study and individual. We compose a scrolling story from its GPS track and the best ground-level photos found along the way.",
    "story.build": "Compose the story",
    "story.phaseMatching": "Finding ground imagery…",
    "story.phaseEnriching": "Reading terrain and weather…",
    "story.realDataOnly": "Real data only",
    "story.openMap": "Interactive map →",
    "story.reconfigure": "Reconfigure",
    "story.error": "Could not compose the story. Try again.",
    "story.noImagery": "No real ground imagery was found along this track. The route is still shown, without photo chapters.",
    "story.scrollHint": "Scroll · {count} chapters",
    "story.chapter": "Chapter",
    "story.statDistance": "Total distance",
    "story.statDuration": "Duration",
    "story.statFixes": "GPS fixes",
    "story.statPeriod": "Period",
    "story.daysValue": "{count} days",
    "story.dayLabel": "Day {count}",
    "story.legSummary": "{cumulative} km travelled since the start · +{leg} km since the previous chapter.",
    "story.terrainReading": "Terrain reading",
    "story.photoAlt": "Real ground photo near the track",
    "story.outroTitle": "A story made of real data",
    "story.outroBody": "Every chapter rests on verified GPS fixes, real geotagged photos and the historical weather at the moment of passage. No animal emotion or intent is invented.",
    "story.restart": "Back to start",
